...
const uavDroneConstraints = {
  "N.A. Retail Price": { min: 500, max: 5000, increment: 50 },
  "E-A Retail Price": { min: 500, max: 5000, increment: 50 },
  "A-P Retail Price": { min: 500, max: 5000, increment: 50 },
  "L.A. Retail Price": { min: 500, max: 5000, increment: 50 },
...
function setInputValue(input, value) {
  ...
  if (product === "acCamera") {
    ...
    if (!constraints && normalizedLabel.includes('Retail Price')) {
      const region = normalizedLabel.split(' ')[0]; // Get N.A., E-A, etc.
...
// New helper function to normalize labels for comparison
