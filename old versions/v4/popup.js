...
async function loadState() {
  ...
  if (globalHistory.length > 0) {
    ...
    bestScoreEl.textContent = 'Best EPS: $0.00';
  }
      ...
      async function tryValues() {
        ...
        for (let i = 0; i < selects.length; i++) {
          ...
          if (options.length > 0) {
            ...
            for (const option of options) {
              ...
              clickCalculate();
              const currentScore = getScore();
              if (currentScore !== null && currentScore > bestSelectScore) {
                bestOption = option;
        ...
        if (clickCalculate()) {
          ...
          if (currentScore !== null && currentScore > bestScore) {
            ...
            await handleNewScore(currentScore, captureCurrentValues());
          } else {
